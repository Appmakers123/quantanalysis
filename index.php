...
<div class="wrapper row1" align="center">
  <header id="header" class="hoc clear"> 
    <div >
      <p align="center" style="font-size:30px;font-family:Roboto ; color:white; background-color:rgb(155,186,110)  "></p>
    </div>
   </header>
</div>
...
<table style="width:60%" border="0" align=center>
 ...
 <select name="Course" required id=b>
  <option><b>SWS</b></option>
  <option><b>AIT</b></option>
  <option><b>SE</b></option>
  <option><b> DMBI</b></option>
  <option><b>DS</b></option>
  </select></p>
 </th> 
   <th colspan="3" >
...
//INSERT QUERY
$sql1="INSERT INTO faculty(Dept,Course,Name,AcadYear,Sem,AuditBy,Date) Values('" . $dept . "','" . $Course . "','" . $Name . "','" . $AcadYear . "','" . $Sem . "','"  . $AuditBy . "','"  . $Date . "')";
	$con->query($sql1);
...
$row=$r->fetch_assoc();
	$fid=$row["f_id"];
	echo $fid;
$sql02="INSERT INTO teachvalue values('" . $fid . "',1,'" . $CPAE . "','" . $CPAE_2 . "','" . $CPAE_3 . "')";
$sql3="INSERT INTO teachvalue values('" . $fid . "',2,'" . $ROTM . "','" . $ROTM_2 .  "','" . $ROTM_3 . "')";
$sql4="INSERT INTO teachvalue values('" . $fid . "',3,'" . $MCWPAP . "','" . $MCWPAP_2 . "','" . $MCWPAP_3 . "')";
$sql5="INSERT INTO teachvalue values('" . $fid . "',4,'" . $EDM . "','" . $EDM_2 . "','" .$EDM_3 . "')";
$sql6="INSERT INTO teachvalue values('" . $fid . "',5,'" . $CBS . "','" . $CBS_2 . "','" . $CBS_3 . "')";
$sql7="INSERT INTO teachvalue values('" . $fid . "',6,'" . $QOUQP . "','" . $QOUQP_2 . "','" . $QOUQP_3 . "')";
$sql8="INSERT INTO teachvalue values('" . $fid . "',7,'" . $CFANDHOD . "','" . $CFANDHOD_2 . "','" . $CFANDHOD_3 . "')";
$sql9="INSERT INTO teachvalue values('" . $fid . "',8,'" . $SP . "','" . $SP_2 . "','" . $SP_3 . "')";
$sql10="INSERT INTO teachvalue values('" . $fid . "',9,'" . $RCAFFA . "','" . $RCAFFA_2 . "','" . $RCAFFA_3 . "')";
$sql11="INSERT INTO teachvalue values('" . $fid . "',10,'" . $IWS . "','" . $IWS_2 . "','" . $IWS_3 . "')";
$sql12="INSERT INTO teachvalue values('" . $fid . "',11,'" . $RMATS . "','" . $RMATS_2 . "','" . $RMATS_3 . "')";
$sql13="INSERT INTO teachvalue values('" . $fid . "',12,'" . $CGATUA  . "','" . $CGATUA_2 . "','" . $CGATUA_3 . "')";
	//}	
